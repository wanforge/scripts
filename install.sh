...
SCRIPTS=(
  ...
  "Security|ssl-toolkit|script/linux/security/ssl-toolkit.sh|SSL/TLS diagnostics & management: remote/local audit, self-signed SAN, TLS handshake debug, Certbot"
  ...
  "App Runtime|install-docker|script/linux/runtime/install-docker.sh|Docker Engine & Docker Compose (with UFW security patch & container diagnostics)"
